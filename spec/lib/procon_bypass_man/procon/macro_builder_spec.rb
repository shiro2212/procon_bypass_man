...
describe ProconBypassMan::Procon::MacroBuilder do
  describe '#build' do
    ...
    describe 'v2 format' do
      ...
      describe 'forward_ikarole1' do
        it do
          expect(described_class.new([:forward_ikarole1]).build).to eq([
            { steps: [
      ...
      describe 'dynamic_ikarole' do
        ...
        it 'normalizes negative degrees' do
          expect(described_class.new([:dynamic_ikarole], context: { left_stick_degree: 0 }).build).to eq([
            { steps: [
              ...
              [:tilt_left_stick_completely_to_90deg],
              [:tilt_left_stick_completely_to_90deg],
              [:tilt_left_stick_completely_to_330deg, :b],
              [:tilt_left_stick_completely_to_330deg, :b],
            ]}
          ])
        end
        ...
        it 'derives the start degree from the current left stick degree' do
          stub_const('ProconBypassMan::Procon::MacroBuilder::DYNAMIC_IKAROLE_END_DEGREE', -30)
