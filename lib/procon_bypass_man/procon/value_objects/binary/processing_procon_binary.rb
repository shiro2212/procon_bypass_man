...
class ProconBypassMan::Domains::ProcessingProconBinary < ProconBypassMan::Domains::Binary::Base
  ...
  def write_as_apply_gyro(gyro: )
    ...
    # binary[23] = gyro_3[0]
    # binary[24] = gyro_3[1]
    binary[13] = 65535.to_binary
    binary[14] = 65535.to_binary
    binary[15] = 65535.to_binary
    binary[16] = 65535.to_binary
    binary[17] = 65535.to_binary
    binary[18] = 65535.to_binary
    binary[19] = 65535.to_binary
    binary[20] = 65535.to_binary
    binary[21] = 65535.to_binary
    binary[22] = 65535.to_binary
    binary[23] = 65535.to_binary
    binary[24] = 65535.to_binary
    return binary
    # binary[13..24] = gyro
    # binary[25..36] = gyro
    # binary[37..48] = gyro
